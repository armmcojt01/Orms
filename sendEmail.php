...
function sendStatusUpdateEmail($email, $firstname, $lastname, $position_name) {
    ...
    try {
        ...
        $mail->Body = "<h1>Dear $firstname $lastname,</h1>
                    <p>We are pleased to inform you that your application for the position of <b>" . strtoupper($position_name) . "</b> has been successfully submitted.</p>
                    <p>Please remain available for further communication regarding the next steps in the selection process. We encourage you to stay safe and take care during this time.</p>
                    <br>
